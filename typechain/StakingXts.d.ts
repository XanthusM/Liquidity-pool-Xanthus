...
interface StakingXtsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "rewardPeriodsCount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "rewardPeriodsCount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class StakingXts extends BaseContract {
  ...
  functions: {
    ...
    rewardPeriodsCount(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    userInfos(
      ...
      [BigNumber, BigNumber, BigNumber] & {
        userRewardPerTokenStaked: BigNumber;
